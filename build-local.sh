...
xcodebuild build \
    ...
    PRODUCT_BUNDLE_IDENTIFIER="com.hammerandchisel.discord3.OpenInDiscord" \
...
cyan -duwsgq -n "Discord 3" -b "com.hammerandchisel.discord3" -i discord-patched.ipa -o "$NAME.ipa" -f "$DEB_FILE" OpenInDiscord/build/OpenInDiscord.appex
